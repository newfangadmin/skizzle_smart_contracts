...
zos add Skizzle
zos push --network testnet
zos create Skizzle --network testnet
```
## Node List mainnet
```json
["0x35626B7e89E393cb03faF4009462480eb52DecCa","0x0997ADb9dBAb6081EF9d9Fb54593547550f6a7B5","0x6b68A9840B92Bf4FdAFd7889A2d6aAfcb45F8b1d","0xA0181fDadfDB538574e54B35746Ca2cc942FA02c","0x813fc51001941F4c8B5D528fd791073869659a95","0x35F0b8F42f59E58EaA0aC535Fd71c8254B4a4cdB"]
```
## Node List testnet
```json
